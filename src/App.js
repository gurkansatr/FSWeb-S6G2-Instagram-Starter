...
const App = () => {
 ...
 const filterGonderiler =  gonderiler.filter((item)=>{
      return (item.username.includes(event.target.value) || item.timestamp.includes(event.target.value)) 
    }) 
  ...
  return (
    <div className="App">
      ...
      <AramaÇubuğu arama={arama} setArama={setArama} changeHandler={changeHandler} />
